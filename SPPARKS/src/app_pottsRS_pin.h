...
#ifdef APP_CLASS
AppStyle(potts/rs_pin,AppPottsRS_pin)

#else

#ifndef SPK_APP_POTTS_RS_PIN_H
#define SPK_APP_POTTS_RS_PIN_H
...
class AppPottsRS_pin : public AppPotts {
  public:

    AppPottsRS_pin(class SPPARKS *, int, char **);
    ~AppPottsRS_pin();
    void init_app();
    void grow_app();
